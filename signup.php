    ...
    <body id="_6">
            ...
            <div id="sf">
                <center>
                    ...
                    <form action="<?php echo htmlspecialchars( $_SERVER["PHP_SELF"] ); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <i class="material-icons" id="lock1">lock</i>
                        <i class="material-icons" id="person1">person</i>
                        ...
                        <i class="material-icons" id="usertypeicon">arrow forward ios</i>
        ...
        <?php
            ...
            if( isset( $_POST["submit"] ) )
            {
                ...
                $query = "INSERT INTO users values( NULL, '$username', '$password', '$name', '$email', CURRENT_TIMESTAMP, '$usertype' )";
